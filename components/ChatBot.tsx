  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'model',
      text: "Hi! I'm Synapse, your AI Tutor. I can search the web for answers, find research papers, or teach you the *best* ways to study (like Active Recall!). What do you need help with?",
      timestamp: new Date()
    }
  ]);
      ...
      >
        ...
        <div className="p-4 bg-gradient-to-r from-indigo-500/10 to-purple-500/10 dark:from-indigo-500/20 dark:to-purple-500/20 border-b border-white/50 dark:border-slate-700 flex items-center justify-between">
             <div className="flex items-center gap-3">
                 ...
                 <div>
                     <h3 className="font-bold text-slate-800 dark:text-white">Synapse AI Tutor</h3>
        ...
        <div className="p-4 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700">
            ...
            <p className="text-center text-[10px] text-slate-400 mt-2">
                Synapse AI can make mistakes. Verify important info.
            </p>
        </div>
