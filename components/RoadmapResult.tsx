...
import { ChevronDown, ChevronUp, CheckCircle2, Circle, Clock, GripVertical, Download, Calendar, ArrowUp, ArrowDown, RotateCcw, Trophy, Sparkles } from 'lucide-react';
...
export const RoadmapResult: React.FC<RoadmapResultProps> = ({ nodes, onUpdateNodes, onRegenerate, onAddXP }) => {
  ...
  const markNodeComplete = (e: React.MouseEvent, id: string) => {
    ...
    const newNodes = nodes.map(n => {
      ...
      if (isComplete) onAddXP(n.xpValue);
      return { 
        ...n, 
